...
// Create a symlink from kudu/src to kudu-examples
// Note: on windowse this command only works if you are an administrator.
// If you cannot run this command, setup the symlink up manually
function createKuduSymLink() {
    fs.ensureSymlinkSync("../../kudu/src/", "../web/src/js/lib/kudulib/src");
}